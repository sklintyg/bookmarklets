$("#harFunktionsnedsattningYes").prop("checked", true).trigger("click");
$("#funktionsnedsattning").val("En text om ingenting.").change();
$("#harAktivitetsbegransningYes").prop("checked", true).trigger("click");
$("#aktivitetsbegransning").val("Additional police were already on campus because a student had notified a teacher of a rumored threat to students.").change();
