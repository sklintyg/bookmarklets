...
$("#orsak-multi-1-beskrivning").val("Denguefeber").change();
$("#orsak-multi-1-datum").val(todayDateString).change();
$("#orsak-multi-2-beskrivning").val("Denguefeber").change();
$("#orsak-multi-2-datum").val(todayDateString).change();
$("#orsak-multi-3-beskrivning").val("Denguefeber").change();
$("#orsak-multi-3-datum").val(todayDateString).change();
$("#orsak-multi-4-beskrivning").val("Denguefeber").change();
$("#orsak-multi-4-datum").val(todayDateString).change();
$("#orsak-multi-5-beskrivning").val("Denguefeber").change();
$("#orsak-multi-5-datum").val(todayDateString).change();
$("#orsak-multi-6-beskrivning").val("Denguefeber").change();
$("#orsak-multi-6-datum").val(todayDateString).change();
$("#orsak-multi-7-beskrivning").val("Denguefeber").change();
