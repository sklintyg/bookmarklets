...
function clickDropdownBoxYearMonth(index) {
    if ("year" === index) {
...
function selectInDropdownYearMonth(index, type) {
    if ("year" === type) {
...
clickDropdownBoxYearMonth("year");
selectInDropdownYearMonth(2, "year");
clickDropdownBoxYearMonth("month");
selectInDropdownYearMonth(5, "month");
...
$("#operationAnledning").val("Det behÃ¶vdes").change();
...
$("#forgiftningUppkommelse").val("Detta Ã¤r en kort text.").change();
